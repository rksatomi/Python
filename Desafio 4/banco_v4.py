    ...
    def envelope(*args, **kwargs):  #indicação de argumentos variaveis sem necessidade de reajustar de acordo com o problema
        ...
        try:
            ...
            with open(ROOT_PATH / "log.txt","a", encoding='utf-8') as arquivo:
                ...
                arquivo.write(f"[{data_hora}]\tFunção '{func.__name__.upper()}'\t Executado com argumentos{args} e {kwargs}\t Retornou {resultado}\n")
            return resultado       
        except FileNotFoundError as exc:
            print("Arquivo não existente, criação de arquivo - {exc}")
